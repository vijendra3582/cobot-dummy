...
use App\Subscribe;
class SubscribeExport implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents,WithHeadingRow
{
    /**
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $event->sheet->getDelegate()->getStyle('A1:C1')->getFont()->setBold(500); 
                $event->sheet->getDelegate()->getStyle('A1:C1')->getFont()->setBold(500); 
