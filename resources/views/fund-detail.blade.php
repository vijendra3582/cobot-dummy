...
<!-- /** outcome period values **/ ===============================================
    ...
    @if($fund['is_outcome_product'] == true)         
        ...
        if(($fund['display_current_outcome_period_values'] == true)){
            ...
            $INDEX_RETURN = !empty($SPX_PERIOD_RETURN) ? (float)$SPX_PERIOD_RETURN : '0';
            //echo $SPX_PERIOD_RETURN." | ".$TOTAL_BUFFER;
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr class="nobg subhead-row">
                                        ...
                                        <th scope="col" class="text-center text-nowrap">S&P Downside to Floor of Buffer</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $fund['fund_current_outcome'][0]['override_remaining_buffer'] == (int)1 ? (!empty($fund['fund_current_outcome'][0]['remaining_buffer']) ? $fund['fund_current_outcome'][0]['remaining_buffer'] : 'N/A') : $REMAINING_BUFFER }}</td>
                                        <td class="text-center">{{ $fund['fund_current_outcome'][0]['override_downside_before_buffer'] == (int)1 ? (!empty($fund['fund_current_outcome'][0]['downside_before_buffer']) ? $fund['fund_current_outcome'][0]['downside_before_buffer'] : 'N/A' ) : $DOWNSIDE_TO_BUFFER }}</td>

                                        <td class="text-center">{{ $S_P_DOWNSIDE_TO_FLOOR_OF_BUFFER }}</td>
