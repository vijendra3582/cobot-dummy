...
<section class="login-section">
    <div class="login-box">
        ...
        <div class="" style="margin-top: 20px;">
            ...
            @else
                <h2 class="message">Please register to admin</h2>   
            @endif 
            
            <form action="{{url('/cms/add-admin')}}" method="post">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="useremail" name="email" value="" autocomplete="off">
                </div>
