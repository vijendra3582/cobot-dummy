                    ...
                    <tbody>
                        ...
                        @endphp
                            ...
                            <tr>
                                ...
                                <td>{{round($fundOutcome['fund_return'],2)}}%</td>
                                <td style="min-width:90px;">{{$fundOutcome['index']}}</td>
                                <td>{{round($fundOutcome['index_return'],2)}}%</td>
                                <td>{{$fundOutcome['upside_participation']}}</td>
                                <td>{{round($fundOutcome['remaining_buffer'],2)}}%</td>
                                <td>{{round($fundOutcome['downside_to_buffer'],2)}}%</td>
